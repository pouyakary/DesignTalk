    ...
    (function (Render) {
        ...
        (function (SVGLayers) {
            ...
            (function (Shapes) {
                function render(model) {
                    const sortedShapes = model.shapes.sort((a, b) => a.zIndex - b.zIndex);
                    const elementedShapes = sortedShapes.map(shape => React.createElement(Render.Editor.Shape, { shape: shape, key: Shapes_2.generateKey() }));
                    return elementedShapes;
                }
                Shapes.render = render;
            })(Shapes = SVGLayers.Shapes || (SVGLayers.Shapes = {}));
        })(SVGLayers = Render.SVGLayers || (Render.SVGLayers = {}));
    })(Render = Shapes_2.Render || (Shapes_2.Render = {}));
})(Shapes || (Shapes = {}));
var Shapes;
(function (Shapes) {
    var SpeachCommandEngine;
